...
def main():
    ...
    conv1 = tf.layers.conv2d(inputs=x_image, filters=16, kernel_size=[3, 3], padding="same",
    ...
    dropout = tf.layers.dropout(inputs=pool2_flat,rate=rate);
    ...
    folder = "4_mnist_conv_dropoutyes_lr" + str(learning_rate);
    ...
    feed_dict_val = {x: data.eval_data, y_true: data.eval_labels, rate: 0.}
    ...
    while i <= max_iterations:
        ...
        feed_dict_train = {x: x_batch, y_true: y_batch, rate: 0.5};
