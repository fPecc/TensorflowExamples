...
def main():
    ...
    conv1 = tf.layers.conv2d(inputs=x_image, filters=32, kernel_size=[5, 5], padding="same",
    ...
    dropout = tf.layers.dropout(inputs=fc,rate=rate);
    ...
    folder = "5_mnist_conv_dropoutyes_lr" + str(learning_rate);
